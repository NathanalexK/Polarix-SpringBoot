...
public class ImageCompressor {
    ...
    final float MAX_COMPRESSION_SIZE; //2MB

    public ImageCompressor(final float maxCompression) {
        this.MAX_COMPRESSION_SIZE = maxCompression;
    }

    public  byte[] compressImage(byte[] bytes, float imageQuality) throws IOException {
